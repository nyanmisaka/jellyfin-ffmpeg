...
__global__ void tonemap(FFCUDAFrame src, FFCUDAFrame dst,
                        cudaTextureObject_t ditherTex, float *unused)
{
    _READER
    _YUV2RGB
    _TONEMAP
...
__global__ void tonemap_d(FFCUDAFrame src, FFCUDAFrame dst,
                          cudaTextureObject_t ditherTex, float *unused)
{
    _READER
    _YUV2RGB
...
__global__ void tonemap_dovi(FFCUDAFrame src, FFCUDAFrame dst,
...
__global__ void tonemap_dovi_d(FFCUDAFrame src, FFCUDAFrame dst,
                               cudaTextureObject_t ditherTex, float *doviBuf)
{
    _READER
    _RESHAPE
...
__global__ void tonemap_dovi_f(FFCUDAFrame src, FFCUDAFrame dst,
                               cudaTextureObject_t ditherTex, float *doviBuf)
{
    _READER
    _RESHAPE
...
__global__ void tonemap_dovi_d_f(FFCUDAFrame src, FFCUDAFrame dst,
                                 cudaTextureObject_t ditherTex, float *doviBuf)
{
    _READER
    _RESHAPE
...
__global__ void tonemap_dovi_pq(FFCUDAFrame src, FFCUDAFrame dst,
                                cudaTextureObject_t ditherTex, float *doviBuf)
{
    _READER
    _RESHAPE
...
__global__ void tonemap_dovi_pq_f(FFCUDAFrame src, FFCUDAFrame dst,
                                  cudaTextureObject_t ditherTex, float *doviBuf)
{
    _READER
    _RESHAPE
