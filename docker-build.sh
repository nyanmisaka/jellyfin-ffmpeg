...
prepare_extra_amd64() {
    ...
    pushd ${SOURCE_DIR}
    git clone -b intel-mediasdk-21.3.5 --depth=1 https://github.com/Intel-Media-SDK/MediaSDK
    pushd MediaSDK
    ...
    #pushd ${SOURCE_DIR}
    #git clone -b intel-media-21.3.4 --depth=1 https://github.com/intel/media-driver
    #pushd media-driver
    #mkdir build && pushd build
    #cmake -DCMAKE_INSTALL_PREFIX=${TARGET_DIR} \
    #      -DENABLE_KERNELS=ON \
